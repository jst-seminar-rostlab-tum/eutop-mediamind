...
def delete_organization(
    *, session: Session, db_organization: Organization
) -> None:
...
def get_search_profile_by_id(
    *, session: Session, search_profile_id: uuid.UUID
) -> SearchProfile | None:
...
def create_search_profile(
    *, session: Session, search_profile_create: SearchProfileCreate
) -> SearchProfile:
...
def update_search_profile(
    *,
    session: Session,
    db_search_profile: SearchProfile,
    search_profile_update: SearchProfileUpdate,
) -> SearchProfile:
...
def delete_search_profile(
    *, session: Session, db_search_profile: SearchProfile
) -> None:
