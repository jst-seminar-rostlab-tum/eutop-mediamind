...
class PDFService:
    ...
    def __draw_cover_elements(
        ...
        style = ParagraphStyle(name="HeaderTitle", fontName="DVS", fontSize=10)
    ...
    def __create_summaries_elements(
        ...
        summary_style = ParagraphStyle(
            "Summary", fontName="DVS", fontSize=9, leading=12
        )
        link_style = ParagraphStyle(
            "Link",
            fontName="DVS-Bold",
        ...
        for i, news in enumerate(news_items):
            ...
            story.append(
                Paragraph(
                    f'<a href="#{dest_name}">Read full article</a>', link_style
                )
            )
    ...
    def __create_full_articles_elements(
        ...
        content_style = ParagraphStyle(
            "Content", fontName="DVS", fontSize=11, leading=14
        )
        link_style = ParagraphStyle(
            "Link",
            fontName="DVS-Bold",
        ...
        for idx, news in enumerate(news_items):
            ...
            story.append(
                Paragraph(
                    f'<a href="#toc_summary_{idx}"><u><font color="blue">Read summary</font></u></a>',
                    link_style,
                )
            )
