...
from app.models import Article, Keyword, User, Match
...
async def get_matches_by_search_profile(
    ...
    """
    matches: List[Match] = await MatchRepository.get_matches_by_search_profile(search_profile_id, current_user)
    return matches
