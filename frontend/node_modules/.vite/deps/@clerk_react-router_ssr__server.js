...
// node_modules/@clerk/shared/dist/chunk-6MSQMJ3X.mjs
...
// node_modules/@clerk/react-router/dist/ssr/utils.js
...
// node_modules/@clerk/react-router/dist/utils/env.js
...
// node_modules/@clerk/react-router/dist/ssr/authenticateRequest.js
async function authenticateRequest2(args, opts) {
  const { request } = args;
  ...
  const requestState = await createClerkClient({
    ...
    domain,
    publishableKey,
    userAgent: `${"@clerk/react-router"}@${"1.4.6"}`
...
// node_modules/@clerk/shared/dist/chunk-IBYQ6PKA.mjs
...
// node_modules/@clerk/react-router/dist/ssr/loadOptions.js
...
// node_modules/@clerk/react-router/dist/ssr/rootAuthLoader.js
var rootAuthLoader = async (args, handlerOrOptions, options) => {
  ...
  const _requestState = await authenticateRequest2(args, loadedOptions);
...
// node_modules/@clerk/react-router/dist/ssr/getAuth.js
async function getAuth(args, opts) {
  if (!args || args && (!args.request || !args.context)) {
    throw new Error(noLoaderArgsPassedInGetAuth);
  }
  const loadedOptions = loadOptions(args, opts);
  const requestState = await authenticateRequest2(args, loadedOptions);
...
cookie/index.js:
   ...
   *)
*/
//# sourceMappingURL=@clerk_react-router_ssr__server.js.map
