...
Revision ID: 4d4c0b945082
Revises: 
Create Date: 2025-07-26 14:53:28.826576
...
def upgrade() -> None:
    ...
    sa.Column('pdf_as_link', sa.Boolean(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('logout_config', sa.JSON(), nullable=True, comment='Contains the xpaths to logout from paywalled newspapers'),
    ...
    sa.Column('llm_login_attempt', sa.TIMESTAMP(timezone=True), nullable=True, comment='Last time the LLM approach was attempted'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('breaking_news', sa.Boolean(), nullable=False),
    sa.Column('organization_id', sa.Uuid(), nullable=True),
    sa.Column('language', sa.String(length=2), server_default='en', nullable=False),
    sa.Column('role', sa.Enum('maintainer', 'member', name='user_role_enum'), server_default='member', nullable=False),
    sa.Column('gender', sa.Enum('male', 'female', 'divers', name='gender_enum'), server_default='male', nullable=True),
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('organization_id', sa.Uuid(), nullable=False),
    sa.Column('organization_emails', sa.ARRAY(sa.String()), server_default='{}', nullable=True),
    ...
    sa.Column('status', sa.Enum('PENDING', 'UPLOADED', 'FAILED', 'EMPTY', name='reportstatus'), nullable=False),
